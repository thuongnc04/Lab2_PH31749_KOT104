package com.ncthuong.lab2_ph31749
...
fun main() {
    ...
    val sv1: SinhVienModel = SinhVienModel("Nguyen Van Thuong", "PH31749", 9.5f)

    val sv2: SinhVienModel = SinhVienModel("Do Van Tuan", "PH31763", 10f)

    sv2.daTotNghiep = false
    sv2.tuoi = 22

    val sv3: SinhVienModel = SinhVienModel("Tran Ngoc Tuan", "PH11111", 5f, false, 18)
